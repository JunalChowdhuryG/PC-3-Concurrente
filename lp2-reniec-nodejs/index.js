...
async function startService() {
    ...
    try {
        ...
        console.log('Conectado a MySQL (db-reniec) exitosamente.');
        ...
        console.log(`[*] Esperando mensajes en la cola '${QUEUE_NAME}'. Para salir presione CTRL+C`);
